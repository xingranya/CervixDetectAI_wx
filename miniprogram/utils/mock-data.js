...
const articles = [
  {
    ...
    content: "建议每次完成健康检查后，及时记录日期、项目、摘要、复查安排和想进一步确认的问题。记录内容应来自本人已有资料，不填写处方、诊断结论或急救需求。"
  },
  {
    id: "a2",
    title: "复查提醒为什么重要",
    summary: "固定提醒可以减少遗忘，帮助自己按计划完成健康管理。",
    content: "复查提醒可以帮助用户把后续安排放进日常计划。若身体出现明显不适，应及时前往线下正规医疗机构咨询专业人员。"
  },
  {
    id: "a3",
    title: "就诊前可以准备哪些信息",
    summary: "提前整理历史记录、近期变化和想确认的问题，可以提高线下沟通效率。",
    content: "线下咨询前可准备检查日期、检查项目、历史摘要、正在关注的变化，以及需要向专业人员确认的问题。请避免把本小程序记录当作医疗结论。"
  }
];
